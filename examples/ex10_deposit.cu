...
int main(int argc, char const *argv[])
{
    ...
    pdist.vsigma= 0.00f;
    pdist.Rmean = 0.0082f;
    pdist.Rsigma= 0.0018f;

    //material parameters
    struct materialParameters materials;
    materials.rho[0]= 1200.0f;
    materials.E[0] = 9.0e5f;
    materials.G[0] = 3.0e5f;
    materials.nu[0] = 0.4f;
    materials.e[0] = 0.3f;
    materials.mu[0] = 0.2f;
    materials.mu0[0] = 0.3f;
    ...
    ioHandling::readParticlesVTK(particlesH,"data/ex10_input2.vtu",NumberOfParticles);
